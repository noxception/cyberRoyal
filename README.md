...
| dataUrl             | "https://WebServer/ScriptData/cyberArkSafeAccountList.json"                     | URL where the safes accounts list JSON file can be retrieved. Leave empty if working without the server side script.                                                                                                                                                                                                                                                                                                                                                                                                             |
...
| psConstrainedMode     | boolean 1 (true) or 0 (false)                                                   | If PowerShell is in Constrained Mode, set this to 1 to skip proxy and security settings which require being in Full Language mode.                                                                                                                                                                                                                                                                                                                                     |
